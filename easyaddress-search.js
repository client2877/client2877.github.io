(function () {
  ...
  function getSchoolAttributes(school) {
    return school.attributes
      ...
      : // : apiGet("/SchoolAttributes?schoolId=" + school.id);
        apiGet(
          "https://api.spscloud.ca/SchoolAttributes?schoolId=" + school.id
        );
  }
  ...
  function onContentLoaded() {
    if (buildMarkup()) {
      ...
      //cx.lookupPromise = apiGet("https://api.spscloud.ca/GetLookup");
